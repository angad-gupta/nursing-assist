...
use App\Modules\Notification\Repositories\CustomNotificationRepository;
use App\Modules\Notification\Repositories\RegisteredDeviceInterface;
use App\Modules\Notification\Repositories\RegisteredDeviceRepository;
...
class NotificationServiceProvider extends ServiceProvider
{
    ...
    public function registerDevice(){
        $this->app->bind(RegisteredDeviceInterface::class,RegisteredDeviceRepository::class);
    }

    public function registerCustomNotification(){
        $this->app->bind(CustomNotificationInterface::class,CustomNotificationRepository::class);
    }
    /**
     * Register config.
     *
