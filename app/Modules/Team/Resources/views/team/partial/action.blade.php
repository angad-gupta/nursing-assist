...
<fieldset class="mb-3">
    <legend class="text-uppercase font-size-sm font-weight-bold"></legend>
            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    <div class="row">
                        <label class="col-form-label col-lg-3">Member Name:<span class="text-danger">*</span></label>
                        <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                            <div class="input-group">
                                ...
                                {!! Form::text('member_name', $value = null, ['id'=>'member_name','placeholder'=>'Enter Member Name','class'=>'form-control']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                        <div class="row">
                            ...
                            <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                                @if($is_edit)
                                    @php
                                        $image = ($team_info->profile_pic) ? asset($team_info->file_full_path).'/'.$team_info->profile_pic : asset('admin/default.png');
