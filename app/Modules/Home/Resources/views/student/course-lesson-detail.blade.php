...
<section class="neta-about neta-lesson nl-d student-hub section-padding">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12">
             <ul class="list-unstyled d-flex">
                 <li><a href="{{ route('lesson-detail',['syllabus_id'=>$syllabus_id,'course_info_id'=>$course_info_id]) }}"  class="btn return-btn">Return Back</a> </li>
                 @if($next_course_content_id != '')
                 <li><a href="{{ route('lesson-plan-detail',['course_content_id'=>$next_course_content_id,'course_info_id'=>$course_info_id,'syllabus_id'=>$syllabus_id]) }}"  class="btn e-btn">Proceed to Next</a> </li>
                 @endif
