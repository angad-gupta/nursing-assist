...
class CreateStudentReadinessResultsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_readiness_results', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('student_readiness_results');
    }
}
