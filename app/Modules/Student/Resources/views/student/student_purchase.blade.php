            ...
            <tbody>
                ...
                <tr>
                    ...
                    @if($value->amount_left !== '0')
                        <a data-toggle="{{$modal}}" data-target="#modal_payment_status" class="btn bg-danger-400 btn-icon rounded-round update_status" student_id="{{ $student_id }}" payment_id ="{{$value->id}}" data-popup="tooltip" data-original-title="Course Payment" data-placement="bottom"><i class="icon-color-sampler"></i></a>
                    @endif
