...
<fieldset class="mb-3">
    <legend class="text-uppercase font-size-sm font-weight-bold"></legend>
            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    <div class="row">
                        <label class="col-form-label col-lg-3">Question:<span class="text-danger">*</span></label>
                        <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                            <div class="input-group">
                                ...
                                {!! Form::text('question', $value = null, ['id'=>'question','placeholder'=>'Enter Question','class'=>'form-control']) !!}
                            </div>
                        </div>
                    </div>
                </div>
             ...
             <div class="form-group row">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                            <div class="input-group">
                                {!! Form::textarea('answer', null, ['id' => 'answer','placeholder'=>'Enter Answer', 'class' =>'form-control textarea_description']) !!}
                            </div>
                        </div>
                    </div>
                </div>
