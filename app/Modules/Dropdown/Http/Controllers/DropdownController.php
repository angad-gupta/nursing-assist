...
class DropdownController extends Controller
{
    ...
    public function store(Request $request)
    {
         ...
         try{
             if($data['dropvalue'] == 'admin'){
                 alertify()->error('** admin ** DropDown value cannot be created');
             }else{
                 $this->dropdown->save($data);
                 alertify()->success('Dropdown Value Created Successfully');
             }
    ...
    public function storeField(Request $request)
    {
         ...
         try{
            ...
            alertify()->success('Dropdown Field Created Successfully');
        }catch(\Throwable $e){
            alertify($e->getMessage())->error();
        }
    ...
    public function update(Request $request, $id)
    {
        $data = $request->all();
         ...
         try{
            ...
            alertify()->success('Dropdown Value Updated Successfully');
        }catch(\Throwable $e){
            alertify($e->getMessage())->error();
        }
    ...
    public function destroy($id)
    {
        try{
            $this->dropdown->delete($id);
             alertify()->success('Dropdown Value Deleted Successfully');
        }catch(\Throwable $e){
            alertify($e->getMessage())->error();
        }
      return redirect(route('dropdown.index'));  
