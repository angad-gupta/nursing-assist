...
namespace App\Modules\Dropdown\Providers;
...
class DropdownServiceProvider extends ServiceProvider
{
    ...
    public function dropdownRegister(){
        $this->app->bind(
            DropdownInterface::class,
            DropdownRepository::class
        );
    }
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'dropdown'
        );
    }
    ...
    {
        $viewPath = resource_path('views/modules/dropdown');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/dropdown';
        }, \Config::get('view.paths')), [$sourcePath]), 'dropdown');
    }
    ...
    {
        $langPath = resource_path('lang/modules/dropdown');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'dropdown');
        } else {
            $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'dropdown');
        }
    }
