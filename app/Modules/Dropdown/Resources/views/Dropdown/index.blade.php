...
@section('title')DropDown @stop
@section('breadcrum')DropDown @stop
...
<div class="card">
    <div class="card-body d-sm-flex align-items-sm-center justify-content-sm-between flex-sm-wrap">
        <a href="{{ route('dropdown.create') }}" class="btn bg-teal-400"><i class="icon-plus-circle2"></i> Add DropDown Value </a>

        <a href="{{ route('dropdown.createField') }}" class="btn bg-warning-400"><i class="icon-plus-circle2"></i> Add DropDown Field </a>
