    ...
    if (typeof d3 == 'undefined') {
      ...
      return;
        ...
        if(element) {
          ...
          var CurrentReadinessTestData = $('input[name=CurrentReadinessTestData]').val();
          var CurrentPracticeTestData = $('input[name=CurrentPracticeTestData]').val();
          var CurrentMockupTestData = $('input[name=CurrentMockupTestData]').val();
        ...
        $(document).ready( function () {
         _pieArcWithLegend("#this_month_test_pie_basic", 170);
       });
